...
class MergeRequestRetriever(BaseRetriever):
    ...
    def __init__(self, gitlab_client: Gitlab, project_id: int | str, merge_request_iid: int | str):
...
if __name__ == "__main__":
    ...
    retriever = MergeRequestRetriever(gitlab_client, project_id, merge_request_iid)
